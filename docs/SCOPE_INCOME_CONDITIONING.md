...
| | |
|---|---|
| Status | **APPROVED AND BUILDABLE. Eleven decisions resolved: D-1, D-4, D-5, D-6, D-7 approved 2026-09-02; D-2 (b) and D-3 (b) approved 2026-09-04; B-1 (a), B-2, B-3 and B-4 approved 2026-09-04 — see §7b.** ⚠ **§8's pre-build gate (steps 1–3) is COMPLETE**, so the next session builds rather than researches. ⚠ **PARTIALLY BUILT — CT v5.65, NM v5.66, NJ v5.67, VA v5.68; RHODE ISLAND OPEN, ONE LEFT.** *(Corrected at v5.68: this cell read "Not yet built." through three populate releases. The v5.67 CHANGELOG records D-NJ-3 as repairing that disagreement; the repair reached `package_check`'s allowlist and not this line.)* |
