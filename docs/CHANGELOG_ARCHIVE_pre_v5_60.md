# Changelog archive — v5.59 and earlier

| | |
|---|---|
| What this is | Every `CHANGELOG.md` entry older than v5.60, moved here verbatim on 2026-09-15 to recover project-knowledge space |
| Where it lives | **Repo only** (`docs/`). Never pooled. The pooled `CHANGELOG.md` holds v5.60 onward and points here |
| Source of the split | `CHANGELOG.md` md5 `2184bde1cd4d4af477a247b69c0072b5` (as of the ops package of 2026-09-15, sixth), cut at the heading that follows the v5.60 entry |
| Provenance | Each release's source and built md5 line (from v5.12, §G) is unchanged below; nothing was edited |
