...
const KNOWN_VERSIONS = ["v541", "v542", "v543", "v544", "v545", "v546", "v547", "v548", "v549"];
if (!KNOWN_VERSIONS.includes(VER)) {
  console.log(`\n  \u2717 FATAL: version tag "${VER}" is not registered in this suite.`);
  console.log("    Registered: " + KNOWN_VERSIONS.join(", "));
  process.exit(1);
}
const POST_FIX = VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549");
...
const POST_ITEM5 = VER === "v547" || (VER === "v548" || VER === "v549");
