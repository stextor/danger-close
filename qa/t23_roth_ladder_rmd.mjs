...
const KNOWN_VERSIONS = ["v539", "v540", "v541", "v542"];
if (!KNOWN_VERSIONS.includes(VER)) {
  console.log(`\n  \u2717 FATAL: version tag "${VER}" is not registered in this suite.`);
  console.log("    Registered: " + KNOWN_VERSIONS.join(", "));
  process.exit(1);
}
const POST_FIX = VER === "v541" || VER === "v542"; // v5.42 carries v5.41's RMD term forward; the §86 fix is $0 at this suite's $70,000 default
