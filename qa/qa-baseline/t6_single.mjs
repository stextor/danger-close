...
await click(tabBtn("ss")); await flush();
{
  ...
  if (VER === "v5101" || VER === "v5102" || VER === "v511" || VER === "v512" || VER === "v513" || VER === "v514" || VER === "v515" || VER === "v516" || VER === "v517" || VER === "v518" || VER === "v519" || VER === "v520") { // fixed at v5.10.1; holds for all later builds
