...
// v5.74 (C-8): Engines B and C consume Engine D's spending draw, so Engine C's MAGI gains an
// EIGHTH term. Gated per leg — the v5.52 block below and every leg through v5.73 keep asserting
// the seven-term form, which is correct FOR THOSE BUILDS (OPERATIONS §B2). A pin that simply
// moved with the code would stop being evidence that the term set is watched at all.
const C8 = (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"));
// v5.77: Engines A, B, C and the Roth tab route §86 through ONE helper (SCOPE_SS86_ONE_RULE), so the
// per-site source text S-3, S-4 and S-6 pinned is gone BY DESIGN. Gated per leg (OPERATIONS §B2): the
// v5.76 and earlier legs keep asserting their own text. A LADDER — widen it each release.
const V577 = VER === "v577";
...
const IS514 = VER === "v514" || VER === "v515" || VER === "v516" || VER === "v517" || VER === "v518" || VER === "v519" || VER === "v520" || VER === "v521" || VER === "v522" || VER === "v523" || VER === "v524" || VER === "v525" || VER === "v526" || VER === "v527" || VER === "v528" || VER === "v529" || VER === "v530" || VER === "v531" || VER === "v532" || VER === "v533" || VER === "v534" || VER === "v535" || VER === "v536" || VER === "v537" || (VER === "v538" || (VER === "v539" || VER === "v540" || VER === "v541" || VER === "v542" || VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"))))); // v5.14 IRMAA indexation Verify checks present
const SRC = fs.readFileSync(new URL(`../${VER}.jsx`, import.meta.url), "utf8");
const V540 = VER === "v540" || VER === "v541" || VER === "v542" || VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"))); // v5.41/v5.42 carry the v5.40 pins forward
const V541 = VER === "v541" || VER === "v542" || VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"))); // v5.42 carries the v5.41 pins forward — its magi term set and RMD basis are unchanged
const V542 = VER === "v542" || VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"))); // v5.43 keeps the §86 upper-tier phase-in
...
const V547 = VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"))); // v5.47: HSA out of the dividend base (S-9); the Roth tab's RMD-exempt share (S-8) // v5.46: the Roth ladder gates spouse B's SS by B's claim date (STRUCT S-7) // v5.45: the §86(a)(1) ½ cap, both places (STRUCT S-6) // v5.42: the §86 upper-tier phase-in (STRUCT S-3)
...
// ═══ Verification suite (statutory constants against cited sources) ═══
{
  ...
  const _verifyCount = (VER === "v532" || VER === "v533" || VER === "v534" || VER === "v535" || VER === "v536" || VER === "v537" || (VER === "v538" || (VER === "v539" || VER === "v540" || VER === "v541" || VER === "v542" || VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577")))))) ? 66 : VER === "v531" ? 62 : IS514 ? 57 : IS510 ? 54 : 53;
...
// ═══ Statics — the source file itself ═══
{
  ...
  if (VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"))) {
    ...
    const _c = (t) => SRC.split(t).length - 1;
    const _C7 = C8
      ? "const magi = ssTaxable + pen_y + work_y + rmdTax_y + conv_y + div_y + capGain_y + ordDraw_y; // v5.74 (C-8): spending draws are MAGI"
  ...
  if (V540) {
    ...
    const _EXPECT = C8
      ? ["ssTaxable", "pen_y", "work_y", "rmdTax_y", "conv_y", "div_y", "capGain_y", "ordDraw_y"]
    ...
    const _V553 = VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577"));
    ...
    if (V542) {
      ...
      if (!V545) {
        ...
        T("STRUCT S-3 (V577): the Roth tab's taxable SS is the shared helper, this year's filing status, rounded to the dollar",
          /^\s*const taxableSS = Math\.round\(taxableSS86\(totalSS, nonSSincome, _filingSingleAt\(year\)\)\);/m.test(SRC));
        T("STRUCT S-3 (V577) §1e: the stale middle-tier [KNOWN DEFECT … t24 §D] comment is gone",
          !SRC.includes("pinned not fixed, see t24"));
      }
    } else {
  ...
  // dated [KNOWN DEFECT] pin asserting the flat rule, which is correct for those builds.
  {
    ...
    // v5.74: the draw is ordinary income, so it owes BOTH the §86 provisional test and MAGI.
    const _prov  = C8
      ? /const _prov86 = pen_y \+ work_y \+ rmdTax_y \+ conv_y \+ div_y \+ capGain_y \+ ordDraw_y \+ ssTot \* 0\.5;/.test(SRC)
      : /const _prov86 = pen_y \+ work_y \+ rmdTax_y \+ conv_y \+ div_y \+ capGain_y \+ ssTot \* 0\.5;/.test(SRC);
    ...
    if (V543) {
      ...
      T("STRUCT S-4 (V543): the phase-in sits BELOW capGain_y (TDZ trap — div_y/capGain_y are declared after the old site)",
        ...
        T("STRUCT S-4 (V577): Engine C calls the shared helper with every provisional-income term",
          /^\s*const ssTaxable = taxableSS86\(ssTot, pen_y \+ work_y \+ rmdTax_y \+ conv_y \+ div_y \+ capGain_y \+ ordDraw_y, _singleI \|\| filingSingleI\);/m.test(SRC));
        // §1f: `filingSingleI` is true only in a MARRIED household's widowed years. Handed alone to the
        // §86 thresholds it taxed a household single from the start on the joint amounts.
        T("STRUCT S-4 (V577) §1f: Engine C no longer takes its §86 thresholds from the widowed-years flag alone",
          !/^\s*const _ssF = taxFactsFor\(filingSingleI\);/m.test(SRC));
        T("STRUCT S-4 (V577): no hardcoded threshold on the call",
          !/taxableSS86\(ssTot[^;]*(25000|32000|34000|44000)/.test(SRC));
        T("STRUCT S-4 (V577): the call sits BELOW capGain_y (the TDZ trap, carried forward)",
          SRC.indexOf("const capGain_y = Math.round(_gainByYrI[yr] || 0);") < SRC.indexOf("const ssTaxable = taxableSS86(ssTot,"));
      }
    } else {
  ...
  // v5.43 and t8 at v5.44. A comment must never be able to satisfy a structural pin.
  {
    ...
    // v5.77 (C-4): Engine A's own copy, found by the Phase-2 audit. Anchored to line start: v5.45's
    // Engine B comment quotes the same shape, and a comment must never satisfy a structural pin.
    const _oldA = /^\s*return Math\.min\(ss \* 0\.85, 0\.5 \* Math\.min\(prov - t1, t2 - t1\) \+ 0\.85 \* \(prov - t2\)\);/m.test(SRC);
    ...
    if (V545) {
      ...
      T("STRUCT S-6 (V545): the Roth tab's upper tier is unchanged (correct since v5.42)",
        ...
        T("STRUCT S-6 (V545-V576) [KNOWN DEFECT 2026-09-24, C-4]: Engine A's upper tier still drops the ½-benefits limb", _oldA);
      } else {
        // v5.77: Engine B, Engine C, Engine A and the Roth tab share ONE §86 implementation,
        // `taxableSS86`, written from the IRS worksheet's lines. The per-site text above is gone by
        // design; these pins move to the helper and to each call. t43 carries the parser-level
        // extinction check (no other function reads the thresholds) and the numerical oracles.
        T("STRUCT S-6 (V577): Engine B calls the shared §86 helper with this year's filing status",
          /^\s*const ssTaxable = taxableSS86\(ssTotal, ordinaryIncome \+ qdcg_y, effSingle\);/m.test(SRC));
        T("STRUCT S-6 (V577): the helper carries worksheet line 14 (the ½-of-benefits limb) into the upper tier",
          /^\s*const line14 = Math\.min\(line2, line13\);/m.test(SRC) && /^\s*const line16 = line14 \+ line15;/m.test(SRC));
        T("STRUCT S-6 (V577): the helper caps at 85% of benefits (worksheet lines 17-18)",
          /^\s*const line17 = line1 \* 0\.85;/m.test(SRC) && /^\s*return Math\.min\(line16, line17\);/m.test(SRC));
        T("STRUCT S-6 (V577) C-4: Engine A's limb-dropping upper tier is gone", !_oldA);
      }
    } else {
...
// leg, which legitimately still has none — the v5.28 defect, not a fix.
{
  ...
  const IS536 = VER === "v536" || VER === "v537" || (VER === "v538" || (VER === "v539" || VER === "v540" || VER === "v541" || VER === "v542" || VER === "v543" || VER === "v544" || VER === "v545" || VER === "v546" || VER === "v547" || (VER === "v548" || VER === "v549" || VER === "v550" || VER === "v551" || VER === "v552" || VER === "v553" || VER === "v554" || VER === "v555" || VER === "v556" || VER === "v557" || VER === "v558" || VER === "v559" || VER === "v560" || VER === "v561" || VER === "v562" || VER === "v563" || VER === "v564" || VER === "v565" || VER === "v566" || VER === "v567" || VER === "v567" || VER === "v568" || VER === "v569" || VER === "v570" || VER === "v571" || VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577")))));
