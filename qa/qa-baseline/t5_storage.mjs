...
const IS5101 = VER === "v5101" || VER === "v5102" || VER === "v511" || VER === "v512" || VER === "v513" || VER === "v514"; // v5.10.1 fixes present (v5101 and later)
const IS5102 = VER === "v5102" || VER === "v511" || VER === "v512" || VER === "v513" || VER === "v514"; // v5.10.2 B-2 fix present (full 13-key wipe)
