...
const KNOWN_VERSIONS = ["v571", "v572", "v573", "v574", "v575", "v576", "v577"];
if (!KNOWN_VERSIONS.includes(VER)) {
  console.log(`\n  \u2717 FATAL: version tag "${VER}" is not registered in this suite.`);
  console.log(`    Registered: ${KNOWN_VERSIONS.join(", ")}`);
  process.exit(1);
}
const POST_FIX = VER === "v572" || VER === "v573" || (VER === "v574" || (VER === "v575" || VER === "v576" || VER === "v577")); // H-1…H-6 land at v5.72 (v5.73 keeps them; it changes only ME/MT state rules)
