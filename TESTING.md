...
**Current build: v5.12** · source `src/DangerClose.jsx` md5 `2ebfccb0ea9744c1015693badace4984` · **418 automated checks green** against that exact source, plus 15 more against the built `index.html`.
...
### Current build (v5.12) — 267 checks in the t1–t6 baseline
