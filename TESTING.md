...
The app is developed against a Node-based suite of six test files — currently **562 checks** — run in full before any release:
...
**Plain disclosure: these suites are not yet published in this repo.** Until they are, "562 green" is a claim you're trusting, not verifying — which is exactly the distinction this project cares about. Publishing the suite is planned; in the meantime, the Verify tab plus the table below are the parts that don't ask for trust.

## Hand-verified ACA figures (v5.7) — check these with a calculator

The ACA engine's test cases were derived by hand from the primary sources and asserted to the dollar. Sources: IRS Rev. Proc. 2025-25 (2026 applicable percentages), HHS/ASPE poverty guidelines (2025: $15,650 + $5,562/person), Rev. Proc. 2021-36 (ARPA table for the "enhanced" scenario).

| Case (single filer, 2026 coverage, $1,562/mo benchmark = $18,000/yr) | Value |
|---|---|
...
| STAY UNDER ACA CLIFF solver, $30,000 other income | converts $62,600 − $30,000 − $562 = $32,100 |
