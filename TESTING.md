...
**Current build: v5.11** · source `src/DangerClose.jsx` md5 `f645a3967c687960bb03227b5ce5bfec` · **381 automated checks green** against that exact source, plus 15 more against the built `index.html`.
